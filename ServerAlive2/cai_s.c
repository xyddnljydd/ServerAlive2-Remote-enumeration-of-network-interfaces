...
extern const MIDL_SERVER_INFO cai_ServerInfo;

extern const RPC_DISPATCH_TABLE cai_v0_0_DispatchTable;

static const RPC_SERVER_INTERFACE cai___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x99fcfec4,0x5260,0x101b,{0xbb,0xcb,0x00,0xaa,0x00,0x21,0x34,0x7a}},{0,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&cai_v0_0_DispatchTable,
    0,
    0,
    0,
    &cai_ServerInfo,
...
RPC_IF_HANDLE cai_v0_0_s_ifspec = (RPC_IF_HANDLE)& cai___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION cai_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE cai_v0_0_DispatchTable = 
    {
    6,
    (RPC_DISPATCH_FUNCTION*)cai_table
    };

static const SERVER_ROUTINE cai_ServerRoutineTable[] = 
    {
...
static const MIDL_SERVER_INFO cai_ServerInfo = 
    {
    &cai_StubDesc,
    cai_ServerRoutineTable,
    cai__MIDL_ProcFormatString.Format,
    cai_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
